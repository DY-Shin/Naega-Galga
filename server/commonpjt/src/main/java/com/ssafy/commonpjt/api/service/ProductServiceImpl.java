...
//            User user =product.getUser();
            User user = userRepository.findByUserIndex(product.getUser().getUserIndex());
            ...
            map.put("optionIndex", (int) option.getOptionIndex());
            map.put("optionAirConditioner", (int) option.getOptionAirConditioner());
            map.put("optionBed", (int) option.getOptionBed());
            map.put("optionCloset", (int) option.getOptionCloset());
            map.put("optionDesk", (int) option.getOptionDesk());
            map.put("optionFridge", (int) option.getOptionFridge());
            map.put("optionGasStove", (int) option.getOptionGasStove());
            map.put("optionInduction", (int) option.getOptionInduction());
            map.put("optionMicrowave", (int) option.getOptionMicrowave());
            map.put("optionWashingMachine", (int) option.getOptionWashingMachine());
            map.put("optionWifi", (int) option.getOptionWifi());
